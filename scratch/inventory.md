...
- `tests/testServer.js` | 8 líneas | Baja | express, supertest
- `utils/handleEmail.js` | 28 líneas | Baja | dotenv, path, nodemailer
- `utils/handleError.js` | 7 líneas | Baja | Ninguna
- `utils/handleJwt.js` | 26 líneas | Baja | jsonwebtoken
- `utils/handlePassword.js` | 15 líneas | Baja | bcryptjs
- `utils/handleSocket.js` | 35 líneas | Baja | express, http, socket.io
- `utils/handleStorage.js` | 34 líneas | Baja | path, multer
- `utils/handleValidator.js` | 13 líneas | Baja | express-validator
- `utils/pdfReportes.js` | 1 líneas | Baja | Ninguna
- `validators/auth.js` | 76 líneas | Baja | express-validator
- `validators/restablecerPassword.js` | 22 líneas | Baja | express-validator
- `validators/solicitud.js` | 30 líneas | Baja | express-validator
- `validators/usuarios.js` | 45 líneas | Baja | express-validator
...
- `app.js` | 113 líneas | Media | dotenv, express, path, cors, cookie-parser, morgan, dotenv, path, express, path, cors, cookie-parser, morgan
