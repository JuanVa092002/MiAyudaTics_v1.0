                        ...
                        <tr key={row._id} className="hover:bg-slate-50/50 transition-colors group">
                          ...
                          <td className="py-6 px-6 align-top">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-[13px] font-medium text-on-surface leading-none">{row.usuario?.nombre || 'Sin usuario'}</span>
                            </div>
                          </td>
                          <td className="py-6 px-6 align-top">
                            <div className="flex items-center gap-2">
                          ...
                          <td className="py-6 px-6 align-top">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-[13px] font-bold text-on-surface">{row.tecnico?.nombre || 'N/A'}</span>
                            </div>
                          </td>
                          <td className="py-6 px-6 align-top">
                            <p className="text-[12px] font-medium text-on-surface-variant leading-relaxed line-clamp-2 italic">
                              {row.solucion?.descripcionSolucion || 'Pendiente de cierre'}
                            </p>
                          </td>
                          <td className="py-6 px-6 align-top">
