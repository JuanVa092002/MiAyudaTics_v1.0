    ...
    <div className="w-[22rem]">
      <div className="border pt-8 pb-4 px-8 flex items-center justify-center flex-col">
        <div className="flex items-center justify-center flex-col mb-8">
          <FontAwesomeIcon className="mb-4 text-7xl text-gray-700" icon={faLock} />
          <p className="text-center mb-2 font-medium">¿Tienes problemas para iniciar sesión?</p>
          <p className="text-center text-slate-600">
            Ingresa tu correo electronico y te enviaremos un enlace para que recuperes el acceso a
            tu cuenta
          </p>
        </div>
