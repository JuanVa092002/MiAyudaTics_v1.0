                      ...
                      <tr key={row._id} className="premium-tr group/row">
                        ...
                        <td className="premium-td">
                           <div className="flex flex-col gap-1.5">
                              ...
                              <span className="text-[11px] font-medium text-slate-400 italic pl-6">{typeof row.usuario === 'object' && row.usuario ? row.usuario.nombre : undefined}</span>
                           </div>
                        </td>
                        <td className="premium-td">
                        ...
                        <td className="premium-td">
                          <div className="p-3 rounded-xl bg-emerald-50/30 border border-emerald-100/50 group-hover/row:bg-emerald-50 transition-colors">
                            <p className="text-[13px] font-semibold text-emerald-900 leading-relaxed">
                              {getSolucionText(row.solucion) || 'Solución documentada'}
                            </p>
                          </div>
                        </td>
                        <td className="premium-td text-center">
                          <div className="flex items-center justify-center gap-2">
                             ...
                             {getSolucionEvidencia(row.solucion) && (
                               <a href={getSolucionEvidencia(row.solucion)} target="_blank" rel="noreferrer" title="Ver resolución" className="w-9 h-9 rounded-lg bg-emerald-100 border border-emerald-200 flex items-center justify-center hover:bg-emerald-500 hover:border-emerald-500 group/link transition-all">
