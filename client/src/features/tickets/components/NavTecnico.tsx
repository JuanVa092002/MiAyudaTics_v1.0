...
export default function NavTecnico(): ReactNode {
  const location = useLocation()

  return (
    <nav className="w-full border-b border-azul-sena bg-white px-3 py-3 lg:max-w-[13%] lg:border-b-0 lg:border-r lg:py-8">
